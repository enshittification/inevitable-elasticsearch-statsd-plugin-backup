...
```
./bin/elasticsearch-plugin install https://github.com/Automattic/elasticsearch-statsd-plugin/releases/download/5.3.3.0/elasticsearch-statsd-5.3.3.0.zip
```

From Maven Central:
```
./bin/elasticsearch-plugin install http://repo1.maven.org/maven2/com/automattic/elasticsearch-statsd/5.3.3.0/elasticsearch-statsd-5.3.3.0.zip
```
...
```
./bin/elasticsearch-plugin install file:///Users/anandnalya/github/automattic/elasticsearch-statsd-plugin/target/releases/elasticsearch-statsd-5.3.3.0.zip
```
