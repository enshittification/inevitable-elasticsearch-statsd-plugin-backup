...
```
bin/plugin install com.automattic/elasticsearch-statsd/2.4.6.0
```
...
bin/plugin file:///absolute/path/to/current/dir/target/releases/elasticsearch-statsd-2.4.6.0.zip
```
